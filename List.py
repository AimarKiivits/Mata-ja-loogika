...
def create_list_with_edge_elements(elements: list) -> list:
    ...
    """
    list_with_edge = [elements[0], elements[-1]]
    return list_with_edge


a = ["a", "b", "c", "d", "e"]
# print(create_list_with_edge_elements(a))
...
# print(get_middle_element_of_list(a))
...
# print(get_middle_part_of_list(a))
...
def create_new_list_with_added_number(numbers: list, number: int) -> list:
    ...
    """
    new_num = [number]
    new_list = numbers + new_num
    return new_list
# print(create_new_list_with_added_number(a, 1))
...
def swap_edge_elements(elements: list) -> list:
    ...
    """
    new_first = elements.pop(-1)
    new_last = elements.pop(0)
    elements.insert(0, new_first)
    elements.append(new_last)
    return elements
# print(swap_edge_elements(a))
...
def add_element_in_position(elements: list, new_element: any, position: int) -> list:
    ...
    return elements
# print(add_element_in_position(a, "b", 1))
...
def get_repeated_list(elements: list, repetiton: int) -> list:
    ...
    """
    repeated = elements * repetiton
    return repeated
# print(get_repeated_list(a, 2))
...
def remove_first_element_from_list(elements: list) -> None:
    ...
    """
    elements.pop(0)
# print(remove_first_element_from_list(a))
